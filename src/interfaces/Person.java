...
/**
 * Business Object Interface for the Person entity.
 *
 * <table>
 *  <tr>
 *   <td colspan=2><strong>Person</strong></td><td colspan=3><em>What a journalist is</em></td>
 *  </tr>
 *  <tr>
 *   <td>&nbsp;</td><td>&nbsp;</td><td>Company</td><td>company</td><td><em>The main or only company this person works for or is speaking for</em></td>
 *  </tr>
 *  <tr>
 *   <td>&nbsp;</td><td>&nbsp;</td><td>java.lang.String</td><td>jobTitle</td><td><em>The job title (Managing Director, Consultant) of the person</em></td>
 *  </tr>
 *  <tr>
 *   <td>&nbsp;</td><td>&nbsp;</td><td>java.lang.String</td><td>lastName</td><td><em>The last name of the person</em></td>
 *  </tr>
 *  <tr>
 *   <td>&nbsp;</td><td>&nbsp;</td><td>java.lang.String</td><td>title</td><td><em>The title (Mr, Miss, Dr etc.) of the person</em></td>
 *  </tr>
 *  <tr>
 *   <td>&nbsp;</td><td>&nbsp;</td><td>java.lang.String</td><td>firstName</td><td><em>The first (i.e. given) name of the person</em></td>
 *  </tr>
 * </table>
 */
public interface Person extends BusinessObject, Contactable, Serializable {
    /**
     * Accessor method for AccountManager.
     * <br>The account manager or other person within our company who deals with this contact
     *
     * @return Employee attribute of this Person.
     */
     ...
     * <br>The account manager or other person within our company who deals with this contact
     *
     * @param aAccountManager set Employee attribute of this Person.
     */
     ...
     *
     * @return PhoneNumber attribute of this Person.
     */
     ...
     * <br>The fax number of the contact
     *
     * @param aFax set PhoneNumber attribute of this Person.
     */
     ...
     *
     * @return java.lang.String attribute of this Person.
     */
     ...
     * <br>The SMTP email address of the contact
     *
     * @param aEmail set java.lang.String attribute of this Person.
     */
     ...
     *
     * @return ContactGroup attribute of this Person.
     */
     ...
     * <br>The main contact group for this contact
     *
     * @param aMainGroup set ContactGroup attribute of this Person.
     */
     ...
     * <br>The website address of the contact (including http://)
     *
     * @param aWww set java.lang.String attribute of this Person.
     */
     ...
     *
     * @return Address attribute of this Person.
     */
     ...
     * <br>The address of this Contactable object
     *
     * @param aAddress set Address attribute of this Person.
     */
     ...
     *
     * @return ContactStatus attribute of this Person.
     */
     ...
     * <br>The status of the contact, expressing what we know about how up-to-date the details are
     *
     * @param aStatus set ContactStatus attribute of this Person.
     */
     ...
     * <br>The first phone number
     *
     * @param aPhone1 set PhoneNumber attribute of this Person.
     */
     ...
     *
     * @return java.util.Date attribute of this Person.
     */
     ...
     * <br>The date this contact was created
     *
     * @param aCreated set java.util.Date attribute of this Person.
     */
     ...
     * <br>The second phone number
     *
     * @param aPhone2 set PhoneNumber attribute of this Person.
     */
     ...
     * <br>General information on the person or company
     *
     * @param aNotes set java.lang.String attribute of this Person.
     */
     ...
     * <br>The last update of this contact.  If null, considered to be equal to created
     *
     * @param aLastUpdate set java.util.Date attribute of this Person.
     */
     ...
     * <br>The mobile phone number of the contact
     *
     * @param aMobile set PhoneNumber attribute of this Person.
     */
     ...
     * <br>knownAs
     *
     * @param aKnownAs set java.lang.String attribute of this Person.
     */
    ...
    /**
     * Get this Person's ContactEvents.
    ...
    /**
     * Add a ContactEvent to this Person's ContactEvents.
     * <br>A set of contact events for this person or company
     *
     * @param aContactEvent ContactEvent to add to this Person's ContactEvents.
     */
    public void addContactEvent(ContactEvent aContactEvent);

    /**
     * Get the elements in this Person's ContactEvents as an 
     * array of ContactEvent[].
     * <br>A set of contact events for this person or company
     *
     * @return ContactEvent[] containing the elements of this Person's ContactEvents.
     */
    public ContactEvent[] getContactEventsAsArray();

    /**
     * Remove an ContactEvent from this Person's ContactEvents.
     * <br>A set of contact events for this person or company
     *
     * @param aContactEvent ContactEvent to remove from this Person's ContactEvents.
     */
    public void removeContactEvent(ContactEvent aContactEvent);

    /**
     * Add a collection of ContactEvents to this Person.
     * <br>A set of contact events for this person or company
     *
     * @param aContactEvents Collection to add to this Person's ContactEvents.
     */
    public void addContactEvents(Collection aContactEvents);

    /**
     * Clear this Person's ContactEvents.
     * <br>A set of contact events for this person or company
     */
    public void clearContactEvents();

    /**
     * Does this Person's ContactEvents contain a particular ContactEvent.
     * <br>A set of contact events for this person or company
     *
     * @param aContactEvent ContactEvent that might be in this Person's ContactEvents.
     *
     * @return boolean is the ContactEvent in this Person's ContactEvents.
     */
     ...
     *
     * @return Company attribute of this Person.
     */
     ...
     * <br>The main or only company this person works for or is speaking for
     *
     * @param aCompany set Company attribute of this Person.
     */
     ...
     * <br>The job title (Managing Director, Consultant) of the person
     *
     * @param aJobTitle set java.lang.String attribute of this Person.
     */
     ...
     * <br>The last name of the person
     *
     * @param aLastName set java.lang.String attribute of this Person.
     */
     ...
     * <br>The title (Mr, Miss, Dr etc.) of the person
     *
     * @param aTitle set java.lang.String attribute of this Person.
     */
     ...
     * <br>The first (i.e. given) name of the person
     *
     * @param aFirstName set java.lang.String attribute of this Person.
     */
